...
def registerprocess(request):
    if request.method == 'POST':
        ...
        try:
            ...
            d=os.path.dirname(os.path.abspath("views.py"))
            print(d)
        ...
        '''if plan == "1":
            ...
            #e_date = s_date + 180'''
        e_date = '2021-1-1'
        cur.execute("INSERT INTO `membership_master`(`User_Id`,`Plan_Id`,`Start_Date`,`End_Date`,`Amount`,`Details`,`Membership_Status`) VALUES ('{}','{}','{}','{}','{}','{}','{}')".format(u_id,planidd,s_date,e_date,planprice,plandetails,'Not Approved'))
        m_id = cur.lastrowid
        conn.commit()
